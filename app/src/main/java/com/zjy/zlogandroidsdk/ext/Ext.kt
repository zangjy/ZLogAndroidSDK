package com.zjy.zlogandroidsdk.ext

import com.zjy.android.zlog.proto.LogOuterClass

fun Any.generateRandomChineseSentence(): String {
...
fun Any.generateRandomLogLevel(): LogOuterClass.Log.Level {
    return mutableListOf(
        LogOuterClass.Log.Level.INFO,
        LogOuterClass.Log.Level.DEBUG,
        LogOuterClass.Log.Level.WARN,
        LogOuterClass.Log.Level.ERROR,
        LogOuterClass.Log.Level.VERBOSE
    ).random()
}